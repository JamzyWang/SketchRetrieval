...
iids = imgList('test');
testDir = '..\data\test\';
saveDir = '..\data\test\learnedScaleMap\';
...
for i = 1:length(iids)
    ...
    RSFilePath = sprintf('../data/test/RS/%d.mat', iid);
    TGFilePath = sprintf('../data/test/raw/MultiTG/%d.mat', iid);
    BGFilePath = sprintf('../data/test/raw/MultiBG/%d.mat', iid);
    CGFilePath = sprintf('../data/test/raw/MultiCG/%d.mat', iid);
